...
class MilkmanMixin(BaseMixin):
    ...
    async def cancel_swap(self, amount_in: int, from_token: str, to_token: str, to: str, price_checker: str, price_checker_data: HexBytes) -> None:
        return await self.call_contract_method('cancelSwap', amount_in, from_token, to_token, to, price_checker, price_checker_data)
    ...
    async def is_valid_signature(self, order_digest: HexBytes, encoded_order: HexBytes) -> HexBytes:
        return await self.call_contract_method('isValidSignature', order_digest, encoded_order)
    async def request_swap_exact_tokens_for_tokens(self, amount_in: int, from_token: str, to_token: str, to: str, price_checker: str, price_checker_data: HexBytes) -> None:
        return await self.call_contract_method('requestSwapExactTokensForTokens', amount_in, from_token, to_token, to, price_checker, price_checker_data)
